...
export default class AddMovementSupplyReception extends Component {
  constructor(props) {
    super(props);
    this.state = {
      orderDate: '',
  ...
  saveMovement = (m) => {
    ...
    MovementServices.SupplyReception(movement, this.state.idStock).then(
      (res) => {
  ...
  render() {
    ...
    return (
      <div>
        <h1>ADD MOVEMENT SUPPLY RECEPTION</h1>
        <Container>
          <form action="">
