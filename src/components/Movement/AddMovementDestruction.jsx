...
export default class AddMovementDestruction extends Component {
  constructor(props) {
    super(props);
    this.state = {
      orderDate: '',
  ...
  saveMovement = (m) => {
    ...
    MovementServices.Destruction(movement, this.state.idStock).then((res) => {
  ...
  render() {
    ...
    return (
      <div>
        <h1>ADD MOVEMENT DESTRUCTION</h1>
        <Container>
          <form action="">
